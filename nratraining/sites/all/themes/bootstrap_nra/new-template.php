 ...
 * Page alter.
 */
function bootstrap_nra_page_alter($page) {
 ...
 */
function bootstrap_nra_preprocess_html(&$variables) {
  /* Color */
  ...
  drupal_add_css(path_to_theme() . '/css/'. $file, array('group' => CSS_THEME, 'weight' => 115,'browsers' => array(), 'preprocess' => FALSE));
	...
	*/
	if (theme_get_setting('bootstrap_js_include', 'bootstrap_nra')) {
	drupal_add_js(drupal_get_path('theme', 'bootstrap_nra') . '/bootstrap/js/bootstrap.min.js');
	}
	//EOF:Javascript
	...
	*/
	if (theme_get_setting('scrolltop_display', 'bootstrap_nra')) {
 ...
 */
function bootstrap_nra_process_html(&$vars) {
 ...
 */
function bootstrap_nra_preprocess_page(&$vars) {
 ...
 */
function bootstrap_nra_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function bootstrap_nra_preprocess_block(&$variables) {
